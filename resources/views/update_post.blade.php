...
<div class="container">
    <div class="justify-content-center">
        <div class="card">
            <div class="card-header">POSTni yangilash</div>
            <div class="card-body">
                <div class="col-12">
                    @if (session('status'))
                ...
                <form action="{{ route('home_show_update_post',$Malumot['id']) }}" method="post"  enctype="multipart/form-data">
                    @csrf 
                    @method('put')
                    <div class="row">
                        <div class="col-lg-12">
                            <label for="title" class="my-2" style="font-weight:500">Post sarlovhasi</label>
                            <input type="text" name="title" value="{{ $Malumot['title'] }}" class="form-control" required>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-12">
                            ...
                            <textarea id="summernote" name="description" required>{{ $Malumot['description'] }}</textarea>
                        </div>
                        <div class="col-12 text-center">
                            <button type="submit" class="btn btn-primary w-50 mt-3">O'zgarishlarni saqlash</button>
                        </div>
                    </div>
                </form>
            </div>
